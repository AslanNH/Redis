...
public class RedisUtil {
    ...
    public Long zSetRem(String key,String value){
        try {
     ...
     * @param values 待添加的数据
     */
    public void addToListRight(String listKey, Expire expire, Object... values) {
        //绑定操作
        BoundListOperations<String, Object> boundValueOperations = redisTemplate.boundListOps(listKey);
        //插入数据
        boundValueOperations.rightPushAll(values);
        //设置过期时间
        boundValueOperations.expire(expire.getTime(),expire.getTimeUnit());
    }
    /**
